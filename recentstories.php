...
<div align="center" class="jumbotron container row">
	<div class="page-header"> Recent Stories </div>
	<ul class="list-group" align="center">
	<?php
  $getstories = "SELECT * FROM stories INNER JOIN user USING(userID)  ORDER BY storyID DESC LIMIT 25";
